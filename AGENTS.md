# AGENTS.md - Protein Function Classification Project
...
- **Jupyter Kernel:** Setelah setup `.venv`, jalankan `.\.venv\Scripts\python.exe -m ipykernel install --user --name=protein-venv --display-name="Python (.venv - Protein)"` lalu pilih kernel ini di setiap notebook agar CUDA terdeteksi.
